...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Account.can_be_used_for_non_products'
        db.add_column('accounts_account', 'can_be_used_for_non_products', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Account.can_be_used_for_non_products'
        db.delete_column('accounts_account', 'can_be_used_for_non_products')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 28, 11, 8, 2, 964716)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 28, 11, 8, 2, 964620)'}),
