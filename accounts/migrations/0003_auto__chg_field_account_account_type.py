...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Account.account_type'
        db.alter_column('accounts_account', 'account_type_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['accounts.AccountType']))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Account.account_type'
        raise RuntimeError("Cannot reverse this migration. 'Account.account_type' and its values cannot be restored.")
    ...
    models = {
        'accounts.account': {
            ...
            'credit_limit': ('django.db.models.fields.DecimalField', [], {'default': "'0.00'", 'null': 'True', 'max_digits': '12', 'decimal_places': '2'}),
        ...
        'accounts.accounttype': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'max_length': '128', 'unique': 'True', 'null': 'True'}),
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 24, 11, 16, 10, 692971)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 24, 11, 16, 10, 692807)'}),
